...
const zend_function_entry util_functions[] = {
	...
	PHP_FE(util_helloworld,	NULL)		/* For testing, remove later. */
	{NULL, NULL, NULL}	/* Must be the last line in util_functions[] */
};
/* }}} */
