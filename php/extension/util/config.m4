...
PHP_ARG_ENABLE(util, enable util support,
  [  --enable-util      Enable util], no)
...
PHP_ARG_WITH(util, for util support,
[  --with-util             Include util support])
